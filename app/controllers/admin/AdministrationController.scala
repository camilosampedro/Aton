...
/**
  ...
  */
class AdministrationController @Inject()(val messagesApi: MessagesApi, userDAO: UserDAO)(implicit executionContext: ExecutionContext) extends Controller with I18nSupport with AuthElement with AuthConfigImpl {
